package com.kserjhfnkedjfv.camerax.util;
...
import com.kserjhfnkedjfv.camerax.activity.CameraActivity;

import java.io.File;

public class CameraParam implements Parcelable {
    private String maskDimensionRatio;//裁剪区域比例 如"h,8:5"
    ...
    private CameraParam(Builder mBuilder) {
        maskDimensionRatio = mBuilder.maskDimensionRatio;
    ...
    private CameraParam startActivity(Activity activity,int requestCode) {
        Intent intent = new Intent(mContext, CameraActivity.class);
        intent.putExtra(CameraConstant.CAMERA_PARAM_KEY, this);
        activity.startActivityForResult(intent, requestCode);
        return this;
    }
    private CameraParam startActivity(ActivityResultLauncher<Intent> launcher) {
        Intent intent = new Intent(mContext, CameraActivity.class);
        intent.putExtra(CameraConstant.CAMERA_PARAM_KEY, this);
    ...
    protected CameraParam(Parcel in) {
        maskDimensionRatio = in.readString();
        front = in.readByte() != 0;
    ...
    public String getMaskDimensionRatio() {
        return maskDimensionRatio == null ? "" : maskDimensionRatio;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeString(maskDimensionRatio);
    ...
    public static class Builder{
        ...
        private String maskDimensionRatio;//裁剪区域比例
        private boolean front = false;
        private String picturePath = Tools.getPicturePath(mContext);
        ...
        public Builder setMaskDimensionRatio(String maskDimensionRatio) {
            this.maskDimensionRatio = maskDimensionRatio;
            return this;
        }
        ...
        public CameraParam build(Activity activity) {
            return new CameraParam(this).startActivity(activity,requestCode);
        }

        public CameraParam build(ActivityResultLauncher<Intent> launcher) {
            return new CameraParam(this).startActivity(launcher);
        }
    }
